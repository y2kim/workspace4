...
if (nexacro.Browser == "Runtime") {
	if (!nexacro.Init_systembase_runtime) {
		...
		nexacro._download = function (url, handle, initname, targetpath, activemode, filedialogpath, filefilter, filefilterindex) {
			var httpheaderstr = "";
			...
			var retArr = nexacro.__downloadFileDownloadHandle(url, handle, initname, targetpath, httpheaderstr, activemode, filedialogpath, filefilter, filefilterindex);
			if (retArr == null) {
