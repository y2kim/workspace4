		...
		if (errstatus < 0) {
			...
			if (is_end) {
				...
				if (is_finish) {
					...
					var downloadret = nexacro._download(excelURL, exportObj._handle, exportfilename_, "undefined", exportObj.exportactivemode, this.parent.filedialogpath, exportObj.filefilter, exportObj.filefilterindex);
