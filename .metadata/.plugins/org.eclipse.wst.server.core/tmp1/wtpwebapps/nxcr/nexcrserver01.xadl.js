(function()
{
    return function()
    {
        ...
        {
            var obj = new ChildFrame("childframe", "absolute", null, null, null, null, null, null, "Base::formmain.xfdl", this);
            this.addChild(obj.name, obj);
            this.frame = obj;

            obj.set_formurl("Base::formmain.xfdl");
        ...
        this.loadIncludeScript("nexcrserver01.xadl", true);
    };
}
)();
